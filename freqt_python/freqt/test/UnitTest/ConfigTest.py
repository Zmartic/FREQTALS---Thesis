...
class MyTestCase(unittest.TestCase):
    ...
    def test1(self):
        ...
        self.assertEqual(self.prop.get_output_file(), "output-abstract-data-testing")
        ...
        self.assertEqual(self.prop.get_abstract_leaves(), False)
    ...
    def test2(self):
        ...
        self.assertEqual(self.prop.get_output_file(), "test/class_data_output_1")
